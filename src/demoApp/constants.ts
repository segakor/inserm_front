    ...
    reviews: [
      {
        ...
        text: "К Марине Васильевне ходила с онихогрифозом на большом пальце. Появляться стал с возрастом, я думала, это у всех, пока дочка не увидела. Сама отвела к подологу. Спасибо огромное, оказалось, просто привыкла обувь неудобную носить.",
        status: "reject",
        date: "",
      },
      {
        ...
        key: "1",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Недавно заметила, что ноготь на большом пальце стал сильно отходить от ложа. Сначала думала, ушиблась, но ни боли, ни черноты не было. Когда не прошло, пошла в Московскую клинику подологии. Доктор Хрущ поставила диагноз - онихолизис, назначила лечение. Сейчас у меня все хорошо.",
        status: "reject",
        date: "",
      },
      {
        ...
        key: "2",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Мучилась с врастающим ногтем несколько лет. Была у разных специалистов, вырезали, но потом все заново. Марина Васильевна смогла помочь насовсем.",
        status: "success",
        date: "",
      },
      {
        ...
        key: "3",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Один раз друг уговорил сходить в бассейн, уже через несколько дней я пожалел об этом. Появился грибок. Мучился, покупал разные гели и мази, только хуже становилось. Наконец решил обратиться в Московскую клинику Подологии. Спасибо Марине Васильевне за помощь. Легче стало уже после первого посещения!",
        status: "delete",
        date: "",
      },
      {
        ...
        key: "4",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Хожу к доктору Хрущ на медицинский педикюр. Потому что в салонах не умеют правильно ухаживать за врастающими ногтями.",
        status: "success",
        date: "",
      },
      {
        ...
        key: "5",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Спасибо Марине Васильевне за грамотную консультацию и полезные рекомендации. Теперь мои ножки довольны)",
        status: "success",
        date: "",
      },
      {
      ...
      },
      {
        ...
        key: "9",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Страдаю от вросшего ногтя уже давно, боролась с ним самостоятельно, постоянно его выстригала, и этого хватало на пару месяцев, чтобы ходить без боли в пальце. Но летом я начала замечать, что на том месте, где врастает ноготь начало появляться покраснение, а через пару дней и отёк. Я решила не медлить, и не запускать данную проблему, в результате обратилась за помощью к Хрущ Марине Васильевне, так как много хорошего слышала о данном специалисте. Как оказалось, она профессионал своего дела, всё понятно разъяснила. В результате правильно подобранного лечения, я теперь забыла про боль в пальце, а самое главное у меня теперь правильный, красивый ноготь, который больше не доставляет мне дискомфорт. Спасибо большое Марине Васильевне! Если вы мучаетесь от данной проблемы, то рекомендую обратиться в Московскую клинику подологии.",
        status: "success",
        date: "",
      },
      {
      ...
      },
      {
        ...
        key: "19",
        link: "https://yandex.ru/profile/174310506876234632",
        text: "Ура, наконец-то избавилась от грибка на ногтях. Благодаря этой клинике и опытному специалисту Марине Васильевне. Лечение долгое, но эффективное. До прихода сюда не думала, что это возможно.",
        status: "wait",
        date: "",
      },
      {
