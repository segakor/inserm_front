    ...
    groppedByType: [
        ...
        cards: [
          {
            ...
            reviews: [
              ...
              },
              {
                id: 3,
                link: "",
                text: "5.  Обращался в ABR чтобы отполировать свою ласточку. Обошлось все удовольствие в 18000 тысяч рублей. Исполнили супер. Машина блестит на солнце, аж глаза режет.",
                status: "success",
                date: 1686660196,
              },
            ],
      ...
      },
      {
        ...
        cards: [
          {
            id: 1,
            link: "https://2gis.ru/firm/70000747474",
            type: "two_gis",
            amount: 2,
            isFinished: false,
            reviews: [
              {
                id: 1,
                link: "",
                text: "Привозила делать керамику на своего жука, оказалось, что при заказе керамического покрытия мойка и антидождь бесплатно. Люблю, когда машина чистая, а когда чистая в подарок - вдвойне)",
                status: "success",
                date: 1686660195,
              },
              {
                id: 2,
                link: "",
                text: "У меня большая семья с собакой, детьми и прочей живностью. После выходных машина похоже на поле битвы, а не на транспорт. Систематически раз в неделю - две приезжаю делать химчистку обоих рядов сидений и пола иногда. Цены не самые низкие в городе, но за качество можно и нужно заплатить.",
                status: "success",
                date: 1686660196,
              },
            ],
